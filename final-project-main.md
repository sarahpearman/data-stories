...
Beyond those aspects, I just iterated *many* times, adding notes where I realized there would be a gap in understanding (especially for a general audience), and changing charts to make them as simple and visually pleasing as possible. My "user with more design background than me" from Part 2 also looked over the final version to help me catch any egregious typos or technical issues.
